...
## 2026-07-16 — AU Operations board refinement

- Added a **View board** entry point on the right side of the AU Operations card on Home.
- Removed OPD Review and Pre-Delivery Checklist from the AU Operations home summary and skills shortcuts.
- Changed the default AU Operations screen to a stage-based pipeline board containing every active stage.
